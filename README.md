...
### Human Evaluation
In the following plot, there is the mean score of each retrieving methods scored by human. The plot shows, that the combination of time-weigthed and metadata retrieving is the best combination.
<figure>
